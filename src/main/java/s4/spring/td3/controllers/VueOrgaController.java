...
public class VueOrgaController {
    ...
    public String index(ModelMap model) {
        ...
        vue.addMethod("save", "var self = this; let item = this.editedItem; if (this.editedIndex > -1) { " + Http.put(rest, (Object) "item", JsArray.replace("self.orgas", "self.editedIndex", "item") + "self.close();") + " } else { " + Http.post(rest, (Object) "item", JsArray.add("self.orgas", "item") + "self.close();") + " };");
